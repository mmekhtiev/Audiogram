...
public class LinearInterpolation {
     ...
     */
    public static byte[] interpolate(int oldSampleRate, int newSampleRate, byte[] samples) {
        ...
        byte[] interpolatedSamples = new byte[newLength];
        ...
        for (int i = 0; i < newLength; i++) {
            ...
            interpolatedSamples[i] = (byte) (slope * positionFromLeft + samples[nearestLeftPosition]); // y=mx+c
        }
